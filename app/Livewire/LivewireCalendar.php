...
class LivewireCalendar extends Component
{
    ...
    public function setupViews(
        ...
        $this->calendarView = $calendarView ?? 'livewire.calendar';
        $this->dayView = $dayView ?? 'livewire.day';
        $this->eventView = $eventView ?? 'livewire.event';
        $this->dayOfWeekView = $dayOfWeekView ?? 'livewire.day-of-week';
    ...
    public function monthGrid()
    {
        ...
        $numbersOfWeeks = round($firstDayOfGrid->diffInWeeks($lastDayOfGrid));
        $days = round($firstDayOfGrid->diffInDays($lastDayOfGrid));
//        dd($numbersOfWeeks, $days, $days%7, $lastDayOfGrid->diffInDays($firstDayOfGrid));
        if ($days % 7 != 0) {
